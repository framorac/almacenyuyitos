...
<html>
    ...
    <body>
        ...
        <div class="ui container" style="margin-top: 100px">
            <div class="column">
                <form class="ui form" method="post" action="agregarPedido.html">
                    <h4 class="ui dividing header">Agregar Nuevo Pedido</h4>
                    <div class="fields">
                    ...
                    <div class="field">
                        <button class="ui button red" type="submit">REGISTRAR PEDIDO</button>
                    </div>
                </form>
            </div>
        </div>        
