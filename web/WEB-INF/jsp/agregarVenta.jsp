...
<html>
    ...
    <body>
        ...
        <div class="ui container" style="margin-top: 100px">
            <div class="column">
                <form class="ui form" method="post" action="agregarVenta.html">
                    <h4 class="ui dividing header">Agregar Nueva Venta</h4>
                    <div class="fields">
                    ...
                    <div class="three fields">
                        ...
                        <div class="field">
                            ...
                            <input type="number" name="cantidad" id="cantidad" onchange="calcularMonto();" min="1">
                        </div>
                        <div class="field">
                            <label for="total">Monto Venta</label>
                            <input type="number" name="total" id="total" min="1" readonly>
                        </div>
                    </div>
                    <div class="field">
                        <button class="ui button grey" type="submit">REGISTRAR VENTA</button>
                    </div>
                </form>
            </div>
        </div>        
