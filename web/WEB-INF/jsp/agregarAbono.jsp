...
<html>
    ...
    <body>
        ...
        <div class="ui container" style="margin-top: 100px">
            <div class="column">
                <form class="ui form" method="post" action="agregarAbono.html">
                    <h4 class="ui dividing header">Nuevo Abono Cliente</h4>
                    <div class="fields">
                    ...
                    <div class="fields">
                        <div class="six wide field">
                            ...
                            <input type="text" name="montoAbono" required>
                        </div>
                        <div></div>
                    </div>
                    <div class="fields">
                        <div class="six wide field">
                            ...
                            <input type="date" name="fechaAbono" required>
                        </div>
                        <div></div>
                    </div>
                    <div class="field">
                        <button class="ui button grey" type="submit">REGISTRAR ABONO</button>
                    </div>
                </form>
            </div>
        </div>        
