...
<html>
    ...
    <body>
        ...
        <div class="ui container" style="margin-top: 100px">
            <div class="column">
                <form class="ui form" method="post" action="agregarProducto.html">
                    ...
                    <div class="five fields">
                        <div class="field">
                            ...
                            <input type="date" name="fechaVencimiento" id="fechaVencimiento" onchange="ObtenerFechaVen();">
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="text" name="codigoProd" id="codigoProd" readonly>
                        </div>
                        <div class="field">
                    ...
                    <div class="four fields">
                        <div class="field">
                            ...
                            <input type="number" name="precioCompra" id="precioCompra" min="1">
                        </div>
                        <div class="field">
                            <label for="precioVenta">Precio Venta</label>
                            <input type="number" name="precioVenta" id="precioVenta" min="1">
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <input type="number" name="stockCritico" id="stockCritico" min="1">
                        </div>
                    </div>
                    <div class="field">
