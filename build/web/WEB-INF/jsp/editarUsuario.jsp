...
<html>
    ...
    <body>
        ...
        <div class="ui container" style="margin-top: 100px">
            <div class="column">
                <form class="ui form" method="post" action="editarUsuario.html">
                    ...
                    <div class="fields">
                        <div class="three wide field">
                            ...
                            <div class="ui left icon input">
                                <input type="text" name="username" value="${usuario[0].USERNAME}" required>
                                <i class="user icon"></i>
                            </div>
                        </div>
                        <div class="three wide field">
                            ...
                            <div class="ui left icon input">
                                <input type="password" name="password" value="${usuario[0].PASSWORD}" required>
                                <i class="lock icon"></i>
                            </div>
                        </div>
                    </div>
                    <div class="fields">
                        <div class="six wide field">
                            ...
                            <input type="email" name="email" value="${usuario[0].EMAIL}" required>
                        </div>
                        <div></div>
                    </div>
                    <div class="field">
                        <button class="ui button red" type="submit">ACTUALIZAR USUARIO</button>
                    </div>
                </form>
            </div>
        </div>        
